...
//    }
    ...
    fun timeLimitFind() {
        val configManager = ConfigManager(
            "C:\\Users\\mailt\\programming_projects\\kotlin_projects\\StreeForge\\src\\test\\kotlin\\configsForTests\\timeLimit.json"
        )
    ...
    @Test
    @DisplayName("Программа корректно тестирует EMA стратегию")
    fun ema() {
        val configManager = ConfigManager(
            "C:\\Users\\mailt\\programming_projects\\kotlin_projects\\StreeForge\\src\\test\\kotlin\\configsForTests\\ema.json"
        )
        val result = StartFind(configManager.load())
